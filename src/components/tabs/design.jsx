  ...
  return (
    <div>
      ...
      <div className='body-holder'> 
        ...
        <img src="https://lh3.googleusercontent.com/pw/AM-JKLU4j8WR-RQWehneoH1WpMqE-6iRDh4C9l1Nzjmn1dVPP6WMR2cQuGMceR4TAJZC1d7aKdUQeQOuUZyfbwYGKXPRJsTkAjlQhDpXYV9TrTsA61HWV0ADPM3xvn9yNhm2KLwB4kunULMxsM5YW11KfA0b=w704-h470-no?authuser=0" className='design-photo' />
      </div>
      <div className='body-holder'>
        <div className='paragraph-holder'>
        ...
        <img src="https://lh3.googleusercontent.com/pw/AM-JKLXSjFyWzHV6kMg7dpKPm9fbzo_PDyGOxPZQ9R8ZklpvkKzam3mx4KI-vS-F3U75FeqvU5tjL_x8VWXtxWCfHCja4jDSflO2eInMjGMIkhhF64QqDq6MnZiZJHL5Tp8Jj4HRVTzPFQuWpec4ZoAE2Y0R=w704-h470-no?authuser=0" className='design-photo' />
      </div>
      <div className='body-holder'>
        <div className='paragraph-holder'>
        ...
        <img src= "https://lh3.googleusercontent.com/pw/AM-JKLU9wbbmgSiymk-oV2kMhJQogmXUvvnxCiwTArO1AWIlW6w2S1-tz9D9oQQ3AHLNHKDgYPRyPhEm8o-CgrBbAVJEMeu1f-cVUESC_fubWroA65FSkTTV-2R9X9FKviAgBgeJEH3MqoW-XNhbr1MPa4m4=w526-h789-no?authuser=0" className='design-photo' id="bottom-photo"/>
      </div>
    </div>
  );
}
